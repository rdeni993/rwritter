...
/** Create custom Query */
$category_posts = new WP_Query($search_posts);
                ...
                <div class="interface">
                    <ul>
                        ...
                        <?php if( get_query_var('page') > 1 ): ?>
                            <li><a href="?s=<?php echo get_query_var('s'); ?>&page=<?php echo $offset - 1; ?>">Previous</a></li>
                        <?php endif; ?>
                        
                        <!-- Check Did we need next button -->
                        <?php if( $cat_size == 10 ): ?>
                            <li><a href="?s=<?php echo get_query_var('s'); ?>&page=<?php echo $offset + 1; ?>">Next</a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <!-- EOF INTERFACE -->
